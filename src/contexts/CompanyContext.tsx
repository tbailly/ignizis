    ...
    try {
      ...
      if (isAdmin) {
        ...
        const { data, error } = await supabase
          ...
          .select('id, name, slug, address, company_number, country, status, perm_legal, perm_accounting, perm_finance, accounting_software_url, finance_software_url, compliant_until')
          .order('name');
