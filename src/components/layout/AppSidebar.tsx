              ...
              {!collapsed && (
                <>
                  <div className="flex-1 text-left">
                    <p className="text-sm font-medium truncate">{currentCompany?.company.name || t("common.select")}</p>
                  </div>
          ...
          <DropdownMenuContent align="start" className="w-64">
            {companies.map((uc) => (
              <DropdownMenuItem
                ...
                className={cn("flex items-center gap-2", currentCompany?.company_id === uc.company_id && "bg-accent")}
              >
        ...
        {isAdmin && (
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={location.pathname === "/admin"} tooltip={t("sidebar.admin")}>
